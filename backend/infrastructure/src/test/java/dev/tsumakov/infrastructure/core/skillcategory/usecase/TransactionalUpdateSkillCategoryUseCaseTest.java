...
class TransactionalUpdateSkillCategoryUseCaseTest {

  private static final OffsetDateTime NOW = OffsetDateTime.parse("2026-08-18T10:00:00+02:00");

  @Mock
  private UpdateSkillCategoryUseCaseImpl delegate;
  @Mock
  private TransactionTemplate transactionTemplate;

  private TransactionalUpdateSkillCategoryUseCase useCase;

  @BeforeEach
  void setUp() {
    useCase = new TransactionalUpdateSkillCategoryUseCase(delegate, transactionTemplate);
  }

  @Test
  void shouldExecuteDelegateInsideTransactionAndReturnResult() {
    var command = new UpdateSkillCategoryDto(5, "Backend", "icon.svg");
