...
class TransactionalCreateUserContactUseCaseTest {

  private static final OffsetDateTime NOW = OffsetDateTime.parse("2026-08-18T10:00:00+02:00");

  @Mock
  private CreateUserContactUseCaseImpl delegate;
  @Mock
  private TransactionTemplate transactionTemplate;

  private TransactionalCreateUserContactUseCase useCase;

  @BeforeEach
  void setUp() {
    useCase = new TransactionalCreateUserContactUseCase(delegate, transactionTemplate);
  }

  @Test
  void shouldExecuteDelegateInsideTransactionAndReturnResult() {
    var command = new CreateUserContactDto("Email", "mailto:a@b.c", "mail.svg");
