...
class TransactionalCreateUserEducationPathUseCaseTest {

  private static final OffsetDateTime NOW = OffsetDateTime.parse("2026-08-18T10:00:00+02:00");
  private static final UUID ID = UUID.randomUUID();

  @Mock
  private CreateUserEducationPathUseCaseImpl delegate;
  @Mock
  private TransactionTemplate transactionTemplate;

  private TransactionalCreateUserEducationPathUseCase useCase;

  @BeforeEach
  void setUp() {
    useCase = new TransactionalCreateUserEducationPathUseCase(delegate, transactionTemplate);
  }

  @Test
  void shouldExecuteDelegateInsideTransactionAndReturnResult() {
    var command = new CreateUserEducationPathDto("MIT", "Boston", Map.of("en", "BSc"), NOW,
        NOW.plusYears(4), true);
