...
class TransactionalCreateSkillUseCaseTest {

  private static final OffsetDateTime NOW = OffsetDateTime.parse("2026-08-18T10:00:00+02:00");

  @Mock
  private CreateSkillUseCaseImpl delegate;
  @Mock
  private TransactionTemplate transactionTemplate;

  private TransactionalCreateSkillUseCase useCase;

  @BeforeEach
  void setUp() {
    useCase = new TransactionalCreateSkillUseCase(delegate, transactionTemplate);
  }
